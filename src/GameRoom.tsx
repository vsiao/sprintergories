import { onDisconnect, onValue, ref, runTransaction, serverTimestamp, set, update } from "firebase/database";
...
function GameRoomNameEntry({ roomId, userId }: { roomId: string; userId: string; }) {
    ...
    return <form className="GameRoomNameEntry" onSubmit={submit}>
